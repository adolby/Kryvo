...
cp "${qt_path}/lib/libQt6Core.so.6" "libQt6Core.so.6"
cp "${qt_path}/lib/libQt6Core.so.6.4.2" "libQt6Core.so.6.4.2"
cp "${qt_path}/lib/libQt6Gui.so" "libQt6Gui.so"
cp "${qt_path}/lib/libQt6Gui.so.6" "libQt6Gui.so.6"
cp "${qt_path}/lib/libQt6Gui.so.6.4.2" "libQt6Gui.so.6.4.2"
cp "${qt_path}/lib/libQt6Svg.so" "libQt6Svg.so"
cp "${qt_path}/lib/libQt6Svg.so.6" "libQt6Svg.so.6"
cp "${qt_path}/lib/libQt6Svg.so.6.4.2" "libQt6Svg.so.6.4.2"
cp "${qt_path}/lib/libQt6DBus.so" "libQt6DBus.so"
cp "${qt_path}/lib/libQt6DBus.so.6" "libQt6DBus.so.6"
cp "${qt_path}/lib/libQt6DBus.so.6.4.2" "libQt6DBus.so.6.4.2"
cp "${qt_path}/lib/libQt6XcbQpa.so" "libQt6XcbQpa.so"
cp "${qt_path}/lib/libQt6XcbQpa.so.6" "libQt6XcbQpa.so.6"
cp "${qt_path}/lib/libQt6XcbQpa.so.6.4.2" "libQt6XcbQpa.so.6.4.2"
cp "${qt_path}/lib/libQt6Widgets.so" "libQt6Widgets.so"
cp "${qt_path}/lib/libQt6Widgets.so.6" "libQt6Widgets.so.6"
