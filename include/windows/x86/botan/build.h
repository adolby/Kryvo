...
/*
* This file was automatically generated Wed Jun  4 14:44:37 2014 UTC by
* Andrew@Andrew-Laptop running 'configure.py --os=mingw --cc=gcc --cpu=x86 --link-method=copy --disable-modules=tls,x509'
*
* Target
