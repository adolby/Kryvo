...
make install INSTALL_ROOT="${project_dir}/build/android/arm64_v8a/release/Kryvo/android-build/"

echo "Copying app dependencies..."
androiddeployqt --input "${project_dir}/src/quick/android-libKryvo.so-deployment-settings.json" --output "${project_dir}/build/android/arm64_v8a/release/Kryvo/android-build" --android-platform android-28 --gradle
