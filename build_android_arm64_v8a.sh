...
wget --timestamping --quiet https://github.com/adolby/qt-more-builds/releases/download/qt-5.12.4/qt-opensource-5.12.4-android-arm64_v8a.zip &> /dev/null
echo "Extracting Qt files..."
unzip -qq qt-opensource-5.12.4-android-arm64_v8a.zip &> /dev/null
