...
/*
* This file was automatically generated Wed Nov 11 21:47:13 2015 UTC by
* andrew@Andrews-MBP running 'configure.py --cpu=armv7 --cc=clang --via-amalgamation --minimized-build --disable-shared --enable-modules=aes,base,base64,dev_random,eax,filters,gcm,kdf2,keccak,locking_allocator,pbkdf2,serpent,serpent_simd'
*
* Target
