...
/*
* This file was automatically generated Tue Sep 23 22:04:18 2014 UTC by
* cgresham3@chelseashamsmbp running 'configure.py --cpu=armv7 --cc=clang --via-amalgamation --no-autoload --enable-modules=aes,serpent,serpent_simd,gcm,eax,keccak,pbkdf2,locking_allocator,dev_random,kdf2,aead_filt'
*
* Target
*  - Compiler: clang++ -pthread -O3
*  - Arch: armv7/arm
*  - OS: darwin
*/
