...
/*
* This file was automatically generated Thu Nov  5 21:28:05 2015 UTC by
* andrew@Andrews-MBP running 'configure.py --cpu=armv7 --cc=clang --via-amalgamation --minimized-build --enable-modules=aes,base,base64,dev_random,eax,filters,gcm,kdf2,keccak,locking_allocator,pbkdf2,serpent,serpent_simd'
*
* Target
