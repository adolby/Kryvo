...
/*
* This file was automatically generated Thu Nov  5 19:01:31 2015 UTC by
* andrew@ANDREWDOLBY32A7 running 'configure.py --cpu=x86 --cc=gcc --os=mingw --via-amalgamation --minimized-build --enable-modules=aes,base,base64,eax,filters,gcm,kdf2,keccak,pbkdf2,serpent,win32_stats --disable-shared'
*
* Target
*  - Compiler: g++  -pthread -fstack-protector -std=c++11 -D_REENTRANT -O2 -momit-leaf-frame-pointer
*  - Arch: x86_32/x86_32
*  - OS: mingw
*/
...
#define BOTAN_INSTALL_PREFIX "/mingw"
