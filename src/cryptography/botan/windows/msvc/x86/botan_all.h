...
/*
* This file was automatically generated Wed Nov 11 21:36:53 2015 UTC by
* andrew@ANDREWDOLBY32A7 running 'configure.py --cpu=x86 --cc=msvc --via-amalgamation --minimized-build --disable-shared --enable-modules=aes,base,base64,eax,filters,gcm,kdf2,keccak,pbkdf2,serpent,serpent_simd,win32_stats'
*
* Target
