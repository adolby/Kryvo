...
/*
* This file was automatically generated Mon Jul 20 14:59:01 2015 UTC by
* Andrew@Andrew-Laptop running 'configure.py --cpu=x64 --cc=gcc --os=mingw --via-amalgamation --no-autoload --enable-modules=aes,base,base64,eax,gcm,kdf2,keccak,pbkdf2,serpent,serpent_simd,win32_stats'
*
* Target
