...
/*
* This file was automatically generated Tue Jul 21 15:13:14 2015 UTC by
* Andrew@Andrew-Laptop running 'configure.py --cpu=x64 --cc=gcc --os=mingw --via-amalgamation --no-autoload --enable-modules=aes,base,base64,eax,filters,gcm,kdf2,keccak,pbkdf2,serpent,serpent_simd,win32_stats'
*
* Target
