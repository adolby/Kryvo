...
/*
* This file was automatically generated Thu Sep 18 20:21:20 2014 UTC by
* Andrew@Andrew-Laptop running 'configure.py --os=mingw --via-amalgamation --no-autoload --enable-modules=aes,serpent,serpent_simd,gcm,eax,keccak,pbkdf2,kdf2,aead_filt,win32_stats'
*
* Target
*  - Compiler: g++ -m64 -pthread -msse2 -O3 -momit-leaf-frame-pointer
*  - Arch: x86_64/x86_64
*  - OS: mingw
*/
