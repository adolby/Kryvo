...
/*
* This file was automatically generated Thu Nov  5 18:59:26 2015 UTC by
* andrew@ANDREWDOLBY32A7 running 'configure.py --cpu=x64 --cc=gcc --os=mingw --via-amalgamation --minimized-build --enable-modules=aes,base,base64,eax,filters,gcm,kdf2,keccak,pbkdf2,serpent,serpent_simd,win32_stats --disable-shared'
*
* Target
