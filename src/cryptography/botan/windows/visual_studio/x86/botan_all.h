...
/*
* This file was automatically generated Thu Nov  5 18:54:07 2015 UTC by
* andrew@ANDREWDOLBY32A7 running 'configure.py --cpu=x86 --cc=msvc --via-amalgamation --minimized-build --enable-modules=aes,base,base64,eax,filters,gcm,kdf2,keccak,pbkdf2,serpent,serpent_simd,win32_stats'
*
* Target
