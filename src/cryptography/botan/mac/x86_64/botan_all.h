...
/*
* This file was automatically generated Tue Sep 23 10:53:41 2014 UTC by
* cgresham3@chelseashamsmbp running 'configure.py --cc=clang --via-amalgamation --no-autoload --enable-modules=aes,serpent,serpent_simd,gcm,eax,keccak,pbkdf2,locking_allocator,dev_random,kdf2,aead_filt'
*
* Target
*  - Compiler: clang++ -m64 -pthread -msse2 -O3
*  - Arch: x86_64/x86_64
*  - OS: darwin
*/
