...
Kryvos::ControlButtonFrame::ControlButtonFrame(QWidget* parent)
  : QFrame{parent} {
  const QSize iconSize = QSize{19, 19};

  const QIcon lockIcon = QIcon{QStringLiteral(":/images/lockIcon.png")};
  ...
  const QIcon unlockedIcon = QIcon{QStringLiteral(":/images/unlockIcon.png")};
